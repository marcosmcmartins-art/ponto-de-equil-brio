...
interface DashboardOverviewProps {
  onNavigate: (view: 'materials' | 'products' | 'calculator') => void;
}

export const DashboardOverview = ({ onNavigate }: DashboardOverviewProps) => {
  const { rawMaterials, products } = usePricingStore();
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <QuickActionCard
          title="Matérias-Primas"
          description="Cadastre e gerencie os insumos para produção"
          icon={Boxes}
        ...
        <QuickActionCard
          title="Produtos"
          description="Crie fichas técnicas e calcule custos"
          icon={Package}
        ...
        <QuickActionCard
          title="Calculadora"
          description="Simule preços e margens de lucro"
          icon={TrendingUp}
